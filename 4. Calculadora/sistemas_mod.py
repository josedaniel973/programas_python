def lin():
    x1, y1, z1, r1 = input("Escribe los valores de los 4 coeficientes de la primera igualdad: ").split(",")
    x2, y2, z2, r2 = input("Escribe los valores de los 4 coeficientes de la segunda igualdad: ").split(",")
    x3, y3, z3, r3 = input("Escribe los valores de los 4 coeficientes de la tercera igualdad: ").split(",")
